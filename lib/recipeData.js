...
const recipeDb = async () => {
    ...
    console.log(`  Count: 
        ...
        affiliate_websites:{ ${maps.affiliate_websites.length}, }
        c_group_segment:{ ${maps.c_group_segment.length}, }
        c_group:{ ${maps.c_group.length}, }
        adUnits:{ ${maps.adUnits.length}, }
        segments:{ ${maps.segments.length}, }
        aff_info:{ ${maps.aff_info.length}, }
        campaigns:{ ${maps.campaigns.length}, }
        dimensions:{ ${maps.dimensions.length}, }
        smart_ad:{ ${maps.smart_ad.length} }
